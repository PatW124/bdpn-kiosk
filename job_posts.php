...
<div class="header">
  ...
  <div class="header-right">
    ...
    <a  href="index.php">Home</a>
    <a class="active" id="login" href="./employer/index.php">EMPLOYERS</a>
  </div>
</div>
...
<thead>
  <tr>
    ...
    <th style="text-align:center;">Job Offered</th>
  ...
  <tbody>
     <!-- should be select all here -->
      <?php 
 $result= mysql_query("SELECT * from job_details" ) or die (mysql_error());
...
<td style="text-align:center; word-break:break-all; width:300px;"> <?php echo $row ['company']; ?>
   ...
   <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['email']; ?></td>
    <td style="text-align:center; word-break:break-all; width:200px;"> <?php echo $row ['joboffer']; ?></td>
